    	...
    	<div id="board-list">
    		<div class="container">
				<div class="tab-buttons" style="text-align: center;">
				  	<button :class="{ 'active-btn': activeTab === 'STAY' }" @click="setActiveTab('STAY')" class="btn" style="width: 160px;">숙박</button>
  					<button :class="{ 'active-btn': activeTab === 'RENT' }" @click="setActiveTab('RENT')" class="btn" style="width: 160px;">렌트카</button>
  					<button :class="{ 'active-btn': activeTab === 'LEISURE' }" @click="setActiveTab('LEISURE')" class="btn" style="width: 160px;">레저</button>
				</div>
