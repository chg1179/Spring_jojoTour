		...
		<div class="contents">
				<div class="customer policy">
					...
					<div class="panel border">
						<div class="clear fs14">
							<ul class="left-list">
								...
								<li><a href="#p14">제 14조 할인쿠폰 적용</a></li>
								
							</ul>
							<ul class="right-list">
								<li><a href="#p15">제 15조 캐시 및 포인트</a></li>
								<li><a href="#p16">제 16조 여행상품 등의 공급</a></li>
								<li><a href="#p17">제 17조 환급</a></li>
								<li><a href="#p18">제 18조 청약철회 등</a></li>
								<li><a href="#p19">제 19조 청약철회 등의 효과</a></li>
								<li><a href="#p20">제 20조 개인정보보호</a></li>
								<li><a href="#p21">제 21조 회사의 의무</a></li>
								<li><a href="#p22">제 22조 회원의 ID및 비밀번호에 대한 의무</a></li>
								<li><a href="#p23">제 23조 이용자의 의무</a></li>
								<li><a href="#p24">제 24조 저작권의 귀속 및 이용제한</a></li>
								<li><a href="#p25">제 25조 이용자의 게시물</a></li>
								<li><a href="#p26">제 26조 회사의 면책</a></li>
								<li><a href="#p27">제 27조 분쟁해결</a></li>
								<li><a href="#p28">제 28조 재판권 및 준거법</a></li>
								...
								<dd>
									<div class="box_slt">
										<select class="inp_slt valid" title="이용약관 선택" onchange="$.get('/policy/pol_service.html?agt=jeju&amp;ajax_load=Y&amp;file='+this.value,function(html){$('#policy_wrap').html($(html).find('#policy_wrap').html())})">
											...
											<option value="tpl_service_20180801.html">2018.08.01</option>
										</select>
									</div>
								</dd>
							</dl>
                    ...
                    <div id="policy_wrap">
						...
						<br>
						<div class="panel border" id="p14">
							<dl class="fs15">
								<dt><strong>제 14조 할인쿠폰 적용</strong></dt>
								<dd class="pre"> 
						...
						3. 할인쿠폰은 회사에서 별도로 명시한 경우를 제외하고는 타인에게 양도할 수 없으며, 부정한 목적이나 용도로 사용할 수 없습니다. 이를 위반한 경우 회사는 할인쿠폰을 소멸시키거나 이용자자격을 정지할 수 있습니다. </dd>
							</dl>
						</div>
						<br>
						<div class="panel border" id="p15">
							<dl class="fs15">
								<dt><strong>제 15조 캐시 및 포인트</strong></dt>
								<dd class="pre"> 
						1. 회사는 사이트에서 사용할 수 있는 포인트제도를 운영하며, 포인트는 "캐시"와 "포인트"로 구분됩니다.
						2. "캐시"는 회원이 재화 및 여행상품 구매 등에 대한 결제수단으로 회사가 정한 방식에 따라 충전할 수 있으며 현금과 동일하게 사용 가능한 현금성 포인트이며, "포인트"는 회원이 사이트 또는 외부채널 통해 재화 등의 구입, 이벤트 참여 등을 통해 적립된 비현금성 포인트입니다.
						3. 사이트에서 캐시 및 포인트에 대한 충전, 보유, 선물, 이용 등의 한도를 지정할 수 있습니다. 한도는 사이트의 정책에 따라 개인별로 차등을 둘 수 있으며, 월 또는 1회 충전 한도를 제한할 수 있습니다.
						4. 캐시 및 포인트 사용시에는 유효기간 만료일이 먼저 도래하는 순서대로 사용됩니다. 유효기간이 동일한 경우에는 "포인트", "캐시"순으로 사용됩니다.
						5. 이용자는 캐시 및 포인트의 환급을 요청할 수 있으며, 이 경우 사이트는 캐시 및 포인트에 기록된 잔액을 이용자에게 지급합니다. 다만 환급대상은 "캐시"에 한정되며, "포인트"는 환급대상에서 제외되고 제6항 제4호의 사용액을 산정할 때에도 고려하지 않습니다.
						6. 사이트는 이용자의 요청에 따른 캐시 환급 시 일정 비용을 수수료로 차감할 수 있으며, 캐시에 기록된 잔액에서 해당 수수료를 차감한 나머지 금액을 지급할 수 있습니다. 다만 다음 각 호의 경우에는 수수료를 차감하지 않고 잔액 전부를 환급합니다.
							① 천재지변 등의 사유로 사이트에서 여행상품 예약 등 서비스 제공이 곤란하여 캐시를 사용하지 못하게 된 경우
							② 캐시의 결함으로 사이트에서 여행상품 예약 등 서비스를 제공하지 못하는 경우
							③ 이용자가 사이트에서 결제한 금액 중 취소 발생시 이용자의 의사에 따라 사이트 내 이용자의 계정에 예치한 캐시 금액
							④ 캐시 금액 중 이용권 전환을 통해 적립된 금액(당사 또는 외부에서 유상 구매한 이용권 전환을 통해 적립되고, 선물하기 기능을 통해 이전된 금액 포함)의 환급에 한하여 "환급기준금액"의 60% 이상 사용하는 경우("환급기준금액"이 1만원 이하인 경우에는 80% 이상 사용하는 경우) 다만 여기서의 '사용'은 이용자가 여행상품을 구매하여 캐시 금액이 차감된 경우를 말하며, 선물양도, 타포인트 전환 등은 사용으로 보지 않습니다.
						7. 캐시 및 포인트는 기타 결제수단과 중복 사용이 가능합니다. 다만 할인쿠폰과의 중복사용은 사이트가 정한 개별 할인쿠폰 정책에 따라 결정됩니다.
						8. "캐시"의 유효기간은 마지막 충전, 적립일 또는 사용일로부터 5년이며, "포인트"는 사이트의 정책에 따라 적립일로부터 최대 1년의 범위 내에서 유효기간이 별도로 설정될 수 있습니다. 이용자가 유효기간 내에 사용하지 않은 "포인트"는 유효기간 경과에 따라 자동 소멸되며, “캐시”인 경우 유효기간이 종료된 포인트 금액의 90%가 환급 가능하나, 1,000원 미만의 포인트인 경우 환급되지 않습니다.
						9. 이용자의 회원탈퇴 시 보유하고 있던 포인트는 소멸되며, 탈퇴 후 재가입을 하더라도 이미 소멸된 포인트는 복원되지 아니합니다.
						10. 당사는 "캐시"의 유효기간이 도래하기 30일 전 통지를 포함하여 3회 이상 유효기간의 도래, 연장 가능여부와 방법 등을 문자메시지, 카카오 알림톡 등의 방법으로 통지합니다. 단, 회원이 잘못된 정보를 제공하여 안내정보를 수신하지 못한 책임은 회원 본인에게 있습니다. </dd>
							</dl>
						</div>
						<br>
						<div class="panel border" id="p16">
							<dl class="fs15">
								<dt><strong>제 16조 여행상품 등의 공급</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p18">
							<dl class="fs15">
								<dt><strong>제 18조 청약철회 등</strong></dt>
								<dd class="pre">
						...
						<div class="panel border" id="p19">
							<dl class="fs15">
								<dt><strong>제 19조 청약철회 등의 효과</strong></dt>
								<dd class="pre">
						...
						<div class="panel border" id="p20">
							<dl class="fs15">
								<dt><strong>제 20조 개인정보보호</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p21">
							<dl class="fs15">
								<dt><strong>제 21조 회사의 의무</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p22">
							<dl class="fs15">
								<dt><strong>제 22조 회원의 ID 및 비밀번호에 대한 의무</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p23">
							<dl class="fs15">
								<dt><strong>제 23조 이용자의 의무</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p24">
							<dl class="fs15">
								<dt><strong>제 24조 저작권의 귀속 및 이용제한</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p25">
							<dl class="fs15">
								<dt><strong>제 25조 이용자의 게시물</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p26">
							<dl class="fs15">
								<dt><strong>제 26조 회사의 면책</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p27">
							<dl class="fs15">
								<dt><strong>제 27조 분쟁해결</strong></dt>
								<dd class="pre"> 
						...
						<div class="panel border" id="p28">
							<dl class="fs15">
								<dt><strong>제 28조 재판권 및 준거법</strong></dt>
								<dd class="pre"> 
